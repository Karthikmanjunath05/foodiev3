						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<label for="name"><i class="fa-solid fa-user"></i></label> <input
									type="text" name="name" id="name" placeholder="Your Name"   minlength="5"  maxlength="20" required="required" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="contact" id="contact"
									placeholder="Contact no"  minlength="10"  maxlength="10" required="required" />
							</div>
							<div class="form-group">
								<label for="address"><i class="fa-sharp fa-solid fa-location-dot"></i></label>
